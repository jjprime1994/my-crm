        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            <div className={`text-sm font-medium px-3 py-1.5 rounded-lg ${
              selected.size > 0 ? "bg-blue-50 text-blue-700" : "text-gray-500"
            }`}>
              {selected.size > 0 ? `${selected.size} selected` : "Select leads below"}
            </div>
          </div>
          ...
          <select
            ...
            className="border border-gray-200 rounded-xl px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 min-w-[200px]"
          >
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2 rounded-xl transition disabled:opacity-40 shadow-sm shadow-blue-200"
          >
            {saving ? (
        ...
        <table className="min-w-full">
          ...
          <tbody className="divide-y divide-gray-50">
            ...
            {leads.map((lead) => (
              <tr
                key={lead.id}
                className={`cursor-pointer transition ${selected.has(lead.id) ? "bg-blue-50" : "hover:bg-gray-50/70"}`}
