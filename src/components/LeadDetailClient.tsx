...
export default function LeadDetailClient({ lead, salespeople, assignmentLogs, currentUser }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      {/* Back */}
      <Button variant="ghost" size="sm" onClick={() => router.back()} className="text-muted-foreground -ml-2 -mt-1">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center shrink-0">
                <span className="text-xl font-bold text-blue-600">{initials(lead.firstName, lead.lastName)}</span>
              </div>
              <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Contact Info</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium mb-0.5">Platform</p>
                  {lead.source === "TIKTOK" ? (
                    <Badge variant="outline" className="text-pink-600 border-pink-200 bg-pink-50">TikTok</Badge>
                  ) : (
                    <Badge variant="outline" className="text-blue-600 border-blue-200 bg-blue-50">Meta</Badge>
                  )}
                </div>
              </div>
            </CardContent>
          ...
          {(() => {
            ...
            return (
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Form Responses</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Notes</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-3">
                {notes.length === 0 && (
                  <li className="text-sm text-muted-foreground text-center py-6 border-2 border-dashed border-gray-100 rounded-xl">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Pipeline</CardTitle>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              {isAdmin && (
                <div className="space-y-1.5">
                  ...
                  <Select value={assignedToId || "unassigned"} onValueChange={(v) => v && setAssignedToId(v === "unassigned" ? "" : v)}>
                    <SelectTrigger className="bg-gray-50">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {followUpAt && (
                    <Button variant="ghost" size="sm" onClick={() => setFollowUpAt("")} className="text-xs h-7 px-2.5 text-muted-foreground">
                      Clear
                    </Button>
                  )}
                </div>
              ...
              {lead.assignedTo && (
                <>
                  <Separator />
                  <div>
                    <p className="text-xs text-muted-foreground font-medium mb-2">Assigned to</p>
              ...
              {assignmentLogs.length > 0 && (
                <>
                  <Separator />
                  <div>
                    <p className="text-xs text-muted-foreground font-medium mb-2">Assignment history</p>
          ...
          {lead.statusHistory.length > 0 && (
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Status History</CardTitle>
              </CardHeader>
              <CardContent>
