  ...
  return (
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Top bar */}
        <header className="flex items-center gap-3 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 px-4 py-2.5 shrink-0">
          {/* Hamburger + logo — mobile only */}
          <button
            onClick={() => setOpen(true)}
            className="lg:hidden text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-white transition p-1"
          ...
          />
          <span className="lg:hidden text-gray-900 dark:text-white font-bold text-sm tracking-tight">Nu Vending</span>
