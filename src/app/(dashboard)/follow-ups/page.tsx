    ...
    <div className="space-y-5 max-w-6xl">
      ...
      <div className="sm:hidden space-y-2">
        {leads.length === 0 ? (
          ...
          const urgent = days >= 5
          return (
            <div key={lead.id} className={`rounded-xl border shadow-sm px-4 py-3.5 ${urgent ? "bg-rose-50/60 border-rose-200" : "bg-white border-gray-100"}`}>
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <Link href={`/leads/${lead.id}`} className="font-medium text-gray-900 text-sm hover:text-blue-600 transition">
                ...
                {lead.phone && (
                  <div className="flex gap-1.5 ml-auto">
                    <a href={`https://wa.me/${lead.phone.replace(/\D/g, "")}`} target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-1 text-xs font-medium bg-emerald-50 text-emerald-700 px-2.5 py-1.5 rounded-lg ring-1 ring-emerald-200">
                    ...
                    <a href={`tel:${lead.phone}`}
                      className="inline-flex items-center gap-1 text-xs font-medium bg-blue-50 text-blue-700 px-2.5 py-1.5 rounded-lg ring-1 ring-blue-200">
